          ...
          <div class="content">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="service">
                  <p class="description">Search to find out the cost of a procedure in your surrounding neighborhood. This data comes from the bills of patients like you as well as publically available Medicare data.</p>                
                </div>
              </div>  
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">   
                <form method="get" action="/results.php">            
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" id="location" name="ZipCode" placeholder="Enter City, State or Zipcode">
                    <div class="clearfix"></div>
                  </div>
